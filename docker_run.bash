...
docker run -it \
  ...
  --privileged \
  -v "$XAUTH:$XAUTH" \
  -v "/home/$USER/autonomous_exploration_development_environment:/home/arg/autonomous_exploration_development_environment" \
  -v "/tmp/.X11-unix:/tmp/.X11-unix" \
  -v "/etc/localtime:/etc/localtime:ro" \
  -v "/dev:/dev" \
  -v "/lib/modules:/lib/modules" \
  --workdir "/home/arg/autonomous_exploration_development_environment" \
  --user "root:root" \
  --name arg \
  --network host \
  --rm \
